...
coor_x = input('Enter the x co-ordinate: ')
coor_y = input('Enter the y co-ordinate: ')
coor_z = input('Enter the z co-ordinate: ')
x0 = np.array([int(coor_x),int(coor_y),int(coor_z)])

print('Enter the initial velocity of the electron:')
vel_x = input('Enter the velocity in x direction: ')
vel_y = input('Enter the velocity in y direction: ')
vel_z = input('Enter the velocity in z direction: ')
v0 = np.array([int(vel_x),int(vel_y),int(vel_z)])

print('Enter the magnitude of magnetic field in space:')
B_x = input('Enter the magnitude of magnetic field in x direction: ')
B_y = input('Enter the magnitude of magnetic field in y direction: ')
B_z = input('Enter the magnitude of magnetic field in z direction: ')
B0 = np.array([int(B_x),int(B_y),int(B_z)])

print('Enter the magnitude of electric field in space :')
E_x = input('Enter the magnitude of electric field in x direction: ')
E_y = input('Enter the magnitude of electric field in y direction: ')
E_z = input('Enter the magnitude of electric field in z direction: ')
E0 = np.array([int(E_x),int(E_y),int(E_z)])

Q0 = input('Enter the magnitude of charge: ')
